...
const Form = ({ title, onSubmit, initialData = {}, isEditing = false }) => {
	...
	return (
		<div>
			<h2 className="font-simpson-title text-center text-4xl text-pink-simp drop-shadow-simpson-title-ds mb-10">
				{title}
			</h2>
			<form
				onSubmit={handleSubmit(handleOnSubmit)}
				className="mx-auto p-10 bg-gray-100 shadow-lg rounded-lg font-simpson-p">
				<div className="mb-6">
					<label
						htmlFor="name"
				...
				<button
					type="submit"
					className="block mx-auto bg-brown-simp w-48 py-3 border border-black rounded-lg shadow-xl hover:bg-amber-800 transition-all duration-300 active:scale-90">

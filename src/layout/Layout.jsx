			...
			<div className="flex-grow">
				<div className="grid xs:grid-cols-5">
					<div className="flex items-end -mb-12 max-xs:hidden">
						<img
							src="/src/assets/images/simpsons-children.png"
							alt="Bart, Lisa y Maggie"
					...
					<div className="max-xs:hidden ml-8 flex flex-col items-end">
						<img
							src="/src/assets/images/curious-bart.png"
							alt="Bart asomado"
							className="w-[80%] sticky top-[15vh]"
						/>
					</div>
				</div>
			</div>

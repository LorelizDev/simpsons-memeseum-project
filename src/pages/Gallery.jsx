...
const Gallery = () => {
  ...
  const initialImages = [
    { id: '1', image: initialImage1},
    { id: '2', image: initialImage2},
    { id: '4', image: initialImage4},
    { id: '6', image: initialImage6},
    { id: '7', image: initialImage7},
    { id: '8', image: initialImage8},
    { id: '9', image: initialImage9},
  ];
	...
	const handlePrev = () => {
		setSelectedIndex(
			(prevIndex) =>
				(prevIndex - 1 + initialImages.length) % initialImages.length
		);
	};
	...
	const currentMeme =
		selectedIndex !== null ? mainMemes[selectedIndex] : null;
